            ...
            <div class="layui-row">
                <div class="layui-col-md12">
                    <div class="layui-carousel" id="carousel">
                        <div carousel-item>
                            @foreach($list['banner'] as $value)
                                <div>
                                    <a href="{{$value->url}}" target="_blank">
                                        <img src="{{asset('upload/'.$value->image) }}" width="100%" alt="">
                                    </a>
                                </div>
                            @endforeach
                        </div>
                ...
                <div class="layui-col-md12">
                    <div class="main zdbox">
                        <div class="subject">
                            <b>[置顶]</b>
                            <a href="{{url('index/details',['id'=>$list['article']->id])}}" title="{{$list['article']->title}}">
                                {{$list['article']->title}}
                            </a>
                            <em> {{$list['article']->created_at}}</em>
                        </div>
                        <div class="content">
                ...
                @foreach($list['news'] as $val)
                    <div class="layui-col-md12">
                        <div class="main list">
                            <div class="subject">
                                <a href="{{ url('index/details',['id' => $val->id]) }}" class="caty">[{{ $val->tit }}]</a>
